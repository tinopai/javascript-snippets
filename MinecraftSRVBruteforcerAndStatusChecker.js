...
Requires: request-promise (https://www.npmjs.com/package/request-promise), didnt use the promise so you can remove it if you want, to use the request package
